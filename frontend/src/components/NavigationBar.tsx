...
export function NavigationBar() {
  ...
  // If user is not authenticated, show simplified nav with auth buttons
  if (!currentUser) {
    return (
            ...
            <div className="flex items-center gap-3">
              <button
                ...
                className={`px-4 py-2 rounded-lg font-medium transition-colors ${
                  isActive('/login')
                    ? 'text-brown border-2 border-sage'
              ...
              <button
                ...
                className={`px-4 py-2 rounded-lg font-medium transition-colors ${
                  isActive('/signup')
                    ? 'bg-sage text-white'
                    : 'bg-sage/90 hover:bg-sage text-white'
                }`}
              >
                Sign Up
              </button>
    ...
    <nav className="bg-card border-b border-brown/10 shadow-sm">
      <div className="mx-auto max-w-7xl px-6 py-4">
        <div className="flex items-center justify-between">
          ...
          {/* Right Icons - Show auth buttons for unauthenticated users */}
          {!currentUser ? (
            <div className="flex items-center gap-3">
              <button
                onClick={() => navigate('/login')}
